...
def plot_covariance_returns_correlation(correlation, title):
    ...
    figure['layout']['xaxis1'].update({'domain': [0, .15]})
    figure['layout']['xaxis1'].update(xaxis2_layout)
    figure['layout']['yaxis1'].update({'domain': [.825, .975]})
    figure['layout']['yaxis1'].update(xaxis2_layout)
